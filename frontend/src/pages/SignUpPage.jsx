...
const SignUpPage = () => {
/**http://localhost:5173/signup?email=abc@gmail.com
 * if we want to get the abc@gmail.com from the url
 ...
 */
    ...
    const handleSignUp=(e)=>{
        // when the form is submitted, we dont want the page to refresh
        e.preventDefault();
        console.log(email,username,password);
        signup({email,username,password})
    }
  return (
    <div className="h-screen w-full hero-bg">sign
